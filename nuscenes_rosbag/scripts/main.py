...
def convert_scene(scene):
    ...
    bag_base_dir = os.path.join(os.path.abspath(os.curdir), "results")
    os.makedirs(bag_base_dir, exist_ok=True)
    bag_path = os.path.join(bag_base_dir, bag_name)
        ...
        for sensor_id, sample_token in cur_sample["data"].items():
            ...
            if sample_data["sensor_modality"] == "camera":
                ...
                write_boxes_imagemarkers(
                    bag, cur_sample["anns"], sample_data, sensor_id, topic, stamp
                )
            ...
            while next_sample_token != "":
                ...
                if next_sample_data["sensor_modality"] == "radar":
                    ...
                    closest_lidar = find_closest_lidar(
                        cur_sample["data"]["LIDAR_TOP"], camera_stamp_nsec
                    )
